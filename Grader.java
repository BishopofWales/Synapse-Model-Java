...
public class Grader {
    ...
    void testLizard(Lizard lizard) {
        ...
        /*
        System.out.println("Food angle:" + randAng);
        System.out.println("Food X: " + worldGeom[0].getX());
        System.out.println("Food Y: " + worldGeom[0].getY());
        System.out.println(
        ...
        */
        ...
        //System.out.println(
        //        "Dist after: " + Raycast.dist(lizard.getX(), lizard.getY(), worldGeom[0].getX(), worldGeom[0].getY()));
