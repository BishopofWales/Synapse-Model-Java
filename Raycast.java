...
public class Raycast{
    public static boolean circleRayCol(double radius, double circ_x, double circ_y, double rayStart_x, double rayStart_y, double rayAngle)
    {
        ...
        return Math.pow(col_x - circ_x, 2) + Math.pow(col_y - circ_y, 2) < Math.pow(radius, 2) && ((Math.cos(rayAngle) > 0) == (circ_x > rayStart_x));
    }
